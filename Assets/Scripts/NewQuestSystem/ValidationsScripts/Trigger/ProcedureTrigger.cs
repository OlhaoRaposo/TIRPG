...
public class ProcedureTrigger : StepModule
{
    ...
    public override void SetActive(bool async)
    {
        ...
        _colliderObject.AddComponent<TriggerCollisionDetector>().SetTrigger(PlayerMovement.instance.GetComponent<Collider>(), !async && destroyOnTrigger, onTriggerEnter.Invoke, onTriggerExit.Invoke);
